      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        {isAdmin && activeTab === 'admin' ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="relative rounded-3xl border border-white/10 bg-[#0a0a0a]/80 backdrop-blur-xl overflow-hidden shadow-2xl p-6 sm:p-8">
            ...
            <div>
              ...
              {/* Desktop Table */}
              <div className="hidden md:block rounded-2xl border border-white/5 bg-[#0a0a0a]/50 backdrop-blur-xl overflow-hidden shadow-2xl">
              ...
              <div className="md:hidden grid gap-4">
                {loading ? (
                  Array.from({ length: 5 }).map((_, i) => (
                    <Card key={i} className="p-4 border-white/5 bg-[#0a0a0a]/50 backdrop-blur-xl">
